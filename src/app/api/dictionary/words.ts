...
export const words: Omit<Word, "id">[] = [
  ...
  { text: "the following", translation: "следующий" },
  { text: "ensure", translation: "обеспечить" },
  { text: "ever", translation: "всегда" },
  { text: "suggestion", translation: "предложениеи" },
  { text: "notice how", translation: "обратите внимание как" },
  { text: "expand", translation: "расширить" },
  { text: "such", translation: "такой" },
  { text: "apply", translation: "применить" },
  { text: "seem", translation: "кажется" },
];
